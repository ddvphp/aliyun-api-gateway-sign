 ...
 * under the License.
 */
namespace DdvPhp\AliyunApiGatewaySign\Http;

use DdvPhp\AliyunApiGatewaySign\Util\Sign;
...
class Util
{
	...
	private static function InitialBasicHeader($path, $appKey, $appSecret, $method, $headers, $querys, $bodys, $signHeaderPrefixList) 
	{
		...
		$headers[SystemHeader::X_CA_SIGNATURE] = Sign::Sign($path, $method, $appSecret, $headers, $querys, $bodys, $signHeaderPrefixList);
